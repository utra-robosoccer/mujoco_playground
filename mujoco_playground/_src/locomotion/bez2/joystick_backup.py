...
from mujoco_playground._src.locomotion.bez2 import base as bez2_base
...
class Joystick(bez2_base.Bez2Env):
  ...
  def _post_init(self) -> None:
    ...
    hip_indices = []
    hip_joint_names = ["hip_roll", "hip_yaw"] # TODO why no hip_pitch
  ...
  def _get_obs(
    ...
    state = jp.hstack([
        ...
        noisy_gravity,  # 3
        info["command"],  # 3
        noisy_joint_angles - self._default_pose,  # 20
        noisy_joint_vel,  # 20
        info["last_act"],  # 20
        phase,
    ])
